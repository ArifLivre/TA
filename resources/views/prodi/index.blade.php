            ...
            <div class="card-body">
                ...
                <div class="row" >
                    ...
                    <div class="col-12 " style="margin-bottom: 0.2cm">
                        <label for="">ID</label>
                        <input type="text" maxlength="12" name="id" class="form-control">
                    </div>
                    <div class="col-12" style="margin-bottom: 0.2cm">
...
function submitform(){
    let form = $('#formA');
    const url = "{{ url('addprodi') }}"; //menggunakan url yang dibuat, data dapat dilihat pada network.
...
const ambilsatudata = (id)=>(
    $.ajax({
        url:`{{url('detailprodi')}}?id=${id}`,
        success:function(ress){
            $("#formA [name='id']").val(id)
            $("#formA [name='program_studi']").val(ress.program_studi)  
