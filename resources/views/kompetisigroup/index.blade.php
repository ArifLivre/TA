...
@section('judul_halaman', 'Data Kompetisi Group')
        ...
        <form class="card" id="formA">
            ...
            <div class="card-body">
                ...
                <div class="row" >
                    ...
                    <div class="col-12" style="margin-bottom: 0.2cm">
                        <label for="">ID Kompetisi</label>
                        <select name="idkompetisi" id="" class="form-control">
                            <option value=""></option>
                    ...
                    <div class="col-12" style="margin-bottom: 0.2cm">
                        ...
                        <select name="idkelompok" id="" class="form-control">
                            <option value=""></option>
...
const ambilsatudata = (id)=>(
    $.ajax({
        url:`{{url('detailkompetisigroup')}}?id=${id}`,
        success:function(ress){
            $("#formA [name='id']").val(id)
            $("#formA [name='idkompetisi']").val(ress.idkompetisi)
            $("#formA [name='idkelompok']").val(ress.idkelompok)
            $("#formA [name='alias']").val(ress.alias)
...
function submitform(){
    let form = $('#formA');
    const url = "{{ url('addkompetisigroup') }}"; //menggunakan url yang dibuat, data dapat dilihat pada network.
...
function clearform(){
    $("#formA [name='id']").val('')
    $("#formA [name='idkompetisi']").val('')
    $("#formA [name='idkelompok']").val('')
    $("#formA [name='alias']").val('')
...
function hapusData(){
    ...
    if(c===true){
        $.ajax({
            url:`{{ url('deletekompetisigroup')}}?id=${id}`,
