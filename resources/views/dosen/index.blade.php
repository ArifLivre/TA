            ...
            <div class="card-body">
                ...
                <div class="row" >
                    ...
                    <div class="col-12" style="margin-bottom: 0.2cm">
                        ...
                        <select name="prodi_dosen" id="" class="form-control">
                            <option value=""></option>
...
const ambilsatudata = (id)=>(
    $.ajax({
        url:`{{url('detaildosen')}}?id=${id}`,
        success:function(ress){
            $("#formA [name='id']").val(id)
            $("#formA [name='dosen_pembimbing']").val(ress.dosen_pembimbing)
            $("#formA [name='prodi_dosen']").val(ress.prodi_dosen)
            $("#formA [name='nip_dosen']").val(ress.nip_dosen)
...
function submitform(){
    let form = $('#formA');
    const url = "{{ url('adddosen') }}"; //menggunakan url yang dibuat, data dapat dilihat pada network.
...
function clearform(){
    ...
    $("#formA [name='prodi_dosen']").val('')
    $("#formA [name='nip_dosen']").val('')
